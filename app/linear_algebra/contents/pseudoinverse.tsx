  ...
  return (
    <>
      ...
      <p>
        ...
        <InlineMath math="\mathbf{B}" /> が同次元の正方行列であり、可逆行列{" "}
        <InlineMath math="\mathbf{P}" /> が存在して
      </p>
      ...
      <ol>
        <li>
          ...
          の場合、
          <InlineMath math="\mathbf{P} = \mathbf{I}" /> です。
        </li>
        <li>
          <b>類似関係の推移性</b>
          <br />
      ...
      <p>
        行列 <InlineMath math="\mathbf{A}" /> と{" "}
        <InlineMath math="\mathbf{B}" /> が類似行列であるとき、累乗行列{" "}
        <InlineMath math="\mathbf{A}^n" /> と
