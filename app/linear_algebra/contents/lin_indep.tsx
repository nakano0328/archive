  ...
  return (
    <>
      ...
      <ul>
        <li>
          ...
          <p>
            ...
            &nbsp;が線形独立であるとき、&nbsp;
            <InlineMath math="\bm{v}_1,\bm{v}_2" />
            &nbsp;や&nbsp;
            <InlineMath math="\bm{v}_1,\bm{v}_3" />
            &nbsp;も線形独立です。
          </p>
        </li>
        <li>
          ...
          <p>
            <InlineMath math="\bm{v}_1,\bm{v}_2" />
            &nbsp;が線形独立であるとき、&nbsp;
            <InlineMath math="c\,\bm{v}_1,c\,\bm{v}_2" />
            &nbsp;も線形独立です。
          </p>
        </li>
      </ul>
      ...
      <p>
        ...
        <br />
        以下のように計算することで、線形独立であることがわかります。ここで、&nbsp;
        <InlineMath math="c_1,c_2" />
        &nbsp;は定数とします。
        <br />
        <br />
      ...
      <p>
        このような式で計算します。この式を満たす定数の組は&nbsp;
        <InlineMath math="c_1 = 0, c_2 = 0" />
        &nbsp;のみです。したがって、&nbsp;
        <InlineMath math="\bm{v}_1,\bm{v}_2" />
        &nbsp;は線形独立といえます。
      </p>
      <br />
      <hr />
      <p>次に以下のベクトルが線形独立であるかどうかを考えます。</p>
      <div className="container">
        <p>
      ...
      <p>
        ...
        <br />
        以下のように計算することで、線形従属であることがわかります。ここで、&nbsp;
        ...
        <br />
        このような式で計算します。この式を満たす定数の組は&nbsp;
        <InlineMath math="c_1 = 0, c_2 = 0, c_3 = 0" />
        &nbsp;以外にも&nbsp;
        <InlineMath math="c_1 = 1, c_2 = 1, c_3 = -1" />
        &nbsp;などがあります。したがって、&nbsp;
        <InlineMath math="\bm{v}_1,\bm{v}_2,\bm{v}_3" />
        &nbsp;は線形従属といえます。
        <br />
