...
export default function pageContent() {
  return (
    <>
      <h2 className="caption">線型結合とは</h2>
      <p>
        線型結合とは、ベクトルのスカラー倍と和を組み合わせたものです。ベクトル
      ...
      <p>
        線型結合は、ベクトルの線型空間において重要な概念です。線型結合を用いることで、ベクトルの生成や線型独立性、基底などを議論することができます。
      </p>

      <h2 className="caption">線型結合の例</h2>
      <p>以下に、線型結合の例を示します。</p>
      <h3>例1</h3>
      <p>
        ベクトル
